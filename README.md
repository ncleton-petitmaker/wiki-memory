...
Current version: `1.0.0-alpha.6`. The executable V1 foundation is present; stable `1.0.0` remains gated on full-scale performance evidence, production recovery evidence, and an external audit. The exact evidence status is recorded in [Release evidence](docs/RELEASE_EVIDENCE.md).
