...
Current version: `1.0.0-alpha.22`. The executable V1 foundation is present; stable `1.0.0` remains gated on production recovery evidence and an external audit. The exact evidence status is recorded in [Release evidence](docs/RELEASE_EVIDENCE.md).
