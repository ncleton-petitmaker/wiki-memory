...
Version actuelle : `1.0.0-alpha.23`. La fondation V1 est exécutable, mais le tag stable `1.0.0` reste conditionné à une restauration sur l’infrastructure de production et à un audit externe. L’état exact des preuves est consigné dans [Évidence de release](docs/RELEASE_EVIDENCE.md).
